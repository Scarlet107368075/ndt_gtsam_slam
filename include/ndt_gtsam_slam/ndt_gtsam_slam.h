...
#include <ndt_gtsam_slam/ground_filter.hpp>
...
private:
  ...
  pcl::NormalDistributionsTransform<PointT, PointT> cpu_ndt_;
  ...
  static pose previous_pose, current_pose, guess_pose;
  static double diff_x, diff_y, diff_z, diff_yaw;
